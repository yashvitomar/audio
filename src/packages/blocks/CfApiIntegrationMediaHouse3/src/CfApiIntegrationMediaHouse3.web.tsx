...
import CfApiIntegrationMediaHouse3Controller, {
  Props,
  configJSON,
} from "./CfApiIntegrationMediaHouse3Controller";

export default class CfApiIntegrationMediaHouse3 extends CfApiIntegrationMediaHouse3Controller {
