//This an auto generated file for Artboard Name = Signinfilledanderror And Supports ReactNative Ver. = 0.62
...
export default class Signinfilledanderror extends React.Component
{
    ...
    textlabel_WrongEmailIDorPwdText: {
        position: "absolute",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(280, true, 1),
        ...
        marginTop: MergeEngineUtilities.deviceBasedDynamicDimension(476, false, 1),
        opacity: 1,
        backgroundColor: "transparent",
        fontStyle: "normal",
        fontWeight: "normal",
    ...
    attrbuted_textlabel_WrongEmailIDorPwdText: {
        position: "relative",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(280, true, 1),
        height: MergeEngineUtilities.deviceBasedDynamicDimension(34, false, 1),
        marginLeft: MergeEngineUtilities.deviceBasedDynamicDimension(55, true, 1),
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		<View 
				style={styles.SigninfilledanderrorView}>
		...
		<TextInput 
			placeholder = {'Yash@124'} 
			style={styles.SUBTITLE1COLORSTYLEText2} 
		/>
		   
		</View>
		  <Text data-elementId='textlabel_WrongEmailIDorPwd' 
			   style={styles.textlabel_WrongEmailIDorPwdText}>Wrong Email ID or Password. Try again or click Forgot password to reset it
		  </Text>
