//This an auto generated file for Artboard Name = SignUpemptystate And Supports ReactNative Ver. = 0.62
...
export default class SignUpemptystate extends React.Component
{
    ...
    textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy6TxtInput: {
        position: "absolute",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(342, true, 1),
        height: MergeEngineUtilities.deviceBasedDynamicDimension(56, false, 1),
        marginLeft: MergeEngineUtilities.deviceBasedDynamicDimension(24, true, 1),
    ...
    textlabel_BycreatinganaccouText: {
        position: "absolute",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(307, true, 1),
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		<View 
				style={styles.SignUpemptystateView}>
		...
		<View data-elementId='textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy6' style={styles.textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy6TxtInput}>
