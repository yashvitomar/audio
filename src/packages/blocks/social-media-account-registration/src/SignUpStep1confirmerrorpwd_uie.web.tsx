//This an auto generated file for Artboard Name = SignUpStep1confirmerrorpwd And Supports ReactNative Ver. = 0.62
...
export default class SignUpStep1confirmerrorpwd extends React.Component
{
    ...
    SignUpStep1confirmerrorpwdView: {
    ...
    textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy4TxtInput2: {
        position: "absolute",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(342, true, 1),
        height: MergeEngineUtilities.deviceBasedDynamicDimension(56, false, 1),
        marginLeft: MergeEngineUtilities.deviceBasedDynamicDimension(24, true, 1),
    ...
    textlabel_PasswordsmustcontaText: {
        ...
        marginTop: MergeEngineUtilities.deviceBasedDynamicDimension(603, false, 1),
        opacity: 1,
        backgroundColor: "transparent",
        fontStyle: "normal",
        fontWeight: "normal",
    ...
    textlabel_BycreatinganaccouText: {
        ...
        marginTop: MergeEngineUtilities.deviceBasedDynamicDimension(665, false, 1),
        opacity: 1,
        backgroundColor: "transparent",
        fontStyle: "normal",
        fontWeight: "normal",
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		<View 
				style={styles.SignUpStep1confirmerrorpwdView}>
		...
		<View data-elementId='textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy4' style={styles.textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy4TxtInput2}>
		...
		/>
		  ...
		  <Text data-elementId='textlabel_Passwordsmustconta' 
			   style={styles.textlabel_PasswordsmustcontaText}>Your passwords don’t match. Please enter your password again to confirm it.
		  </Text>
