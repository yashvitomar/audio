//This an auto generated file for Artboard Name = SignUpStep1filled And Supports ReactNative Ver. = 0.62
...
export default class SignUpStep1filled extends React.Component
{
    ...
    textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy4CopyTxtInput: {
        position: "absolute",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(342, true, 1),
        height: MergeEngineUtilities.deviceBasedDynamicDimension(56, false, 1),
        marginLeft: MergeEngineUtilities.deviceBasedDynamicDimension(24, true, 1),
    ...
    textlabel_BycreatinganaccouText: {
        position: "absolute",
        width: MergeEngineUtilities.deviceBasedDynamicDimension(303, true, 1),
        ...
        marginTop: MergeEngineUtilities.deviceBasedDynamicDimension(618, false, 1),
        opacity: 1,
        backgroundColor: "transparent",
        fontStyle: "normal",
        fontWeight: "normal",
    ...
    button_ButtonsContainedEnabledButton: {
        ...
        height: MergeEngineUtilities.deviceBasedDynamicDimension(56, false, 1),
        marginLeft: MergeEngineUtilities.deviceBasedDynamicDimension(24, true, 1),
        marginTop: MergeEngineUtilities.deviceBasedDynamicDimension(742, false, 1),
        opacity: 1,
        backgroundColor: "rgba(31, 69, 252, 1)",
        borderRadius: MergeEngineUtilities.deviceBasedDynamicDimension(8, true, 1),
    ...
    textlabel_AlreadyhaveanaccoText: {
        ...
        marginTop: MergeEngineUtilities.deviceBasedDynamicDimension(842, false, 1),
        opacity: 1,
        backgroundColor: "transparent",
        fontStyle: "normal",
        fontWeight: "normal",
...
const styles = {...global_styles, ...local_styles}
 	...
 	return (
		...
		<View 
				style={styles.SignUpStep1filledView}>
		...
		<View data-elementId='textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy4Copy' style={styles.textinput_TextFieldFilledLeadingIconNoAssistiveTextRestingCopy4CopyTxtInput}>
