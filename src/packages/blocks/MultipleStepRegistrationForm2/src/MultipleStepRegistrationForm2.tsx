...
import MultipleStepRegistrationForm2Controller, {
  Props,
  configJSON,
} from "./MultipleStepRegistrationForm2Controller";

export default class MultipleStepRegistrationForm2 extends MultipleStepRegistrationForm2Controller {
