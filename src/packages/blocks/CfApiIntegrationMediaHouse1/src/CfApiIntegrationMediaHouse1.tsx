...
import CfApiIntegrationMediaHouse1Controller, {
  Props,
  configJSON,
} from "./CfApiIntegrationMediaHouse1Controller";

export default class CfApiIntegrationMediaHouse1 extends CfApiIntegrationMediaHouse1Controller {
