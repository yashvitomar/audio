...
import CfApiToMicrosoftAzuresVoiceCapability2Controller, {
  Props,
  configJSON,
} from "./CfApiToMicrosoftAzuresVoiceCapability2Controller";

export default class CfApiToMicrosoftAzuresVoiceCapability2 extends CfApiToMicrosoftAzuresVoiceCapability2Controller {
